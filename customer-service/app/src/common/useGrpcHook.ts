...
import { CheckRequest, CheckReply } from "../grpc-web/check_pb";

// Hook for gRPC queries
// TODO: Improve this whole hook for https://github.com/facebook/react/issues/14920 and for typescript
// TODO: See if we can do better than "any" or "CheckRequest"
export const useGrpcRequest = (
  request: (arg0: CheckRequest) => Promise<CheckReply>,
  variables: CheckRequest,
  ...
  const makeRequest = async (newVariables?: CheckRequest) => {
